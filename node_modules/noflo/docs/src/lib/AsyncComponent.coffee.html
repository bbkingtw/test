...
<span class="k">class</span> <span class="nx">AsyncComponent</span> <span class="k">extends</span> <span class="nx">component</span><span class="p">.</span><span class="nx">Component</span>
  ...
  <span class="nv">constructor: </span><span class="nf">(@inPortName=&quot;in&quot;, @outPortName=&quot;out&quot;, @errPortName=&quot;error&quot;) -&gt;</span>
    <span class="nx">unless</span> <span class="nx">@inPorts</span><span class="p">[</span><span class="nx">@inPortName</span><span class="p">]</span>
    ...
    <span class="nx">unless</span> <span class="nx">@outPorts</span><span class="p">[</span><span class="nx">@outPortName</span><span class="p">]</span>
    ...
    <span class="nx">@inPorts</span><span class="p">[</span><span class="nx">@inPortName</span><span class="p">].</span><span class="kc">on</span> <span class="s">&quot;begingroup&quot;</span><span class="p">,</span> <span class="p">(</span><span class="nx">group</span><span class="p">)</span> <span class="o">=&gt;</span>
    ...
    <span class="nx">@inPorts</span><span class="p">[</span><span class="nx">@inPortName</span><span class="p">].</span><span class="kc">on</span> <span class="s">&quot;endgroup&quot;</span><span class="p">,</span> <span class="o">=&gt;</span>
    ...
    <span class="nx">@inPorts</span><span class="p">[</span><span class="nx">@inPortName</span><span class="p">].</span><span class="kc">on</span> <span class="s">&quot;disconnect&quot;</span><span class="p">,</span> <span class="o">=&gt;</span>
    ...
    <span class="nx">@inPorts</span><span class="p">[</span><span class="nx">@inPortName</span><span class="p">].</span><span class="kc">on</span> <span class="s">&quot;data&quot;</span><span class="p">,</span> <span class="p">(</span><span class="nx">data</span><span class="p">)</span> <span class="o">=&gt;</span>
  ...
  <span class="nv">processData: </span><span class="nf">(data) -&gt;</span>
    ...
    <span class="nx">@doAsync</span> <span class="nx">data</span><span class="p">,</span> <span class="p">(</span><span class="nx">err</span><span class="p">)</span> <span class="o">=&gt;</span>
      <span class="k">if</span> <span class="nx">err</span>
        <span class="k">if</span> <span class="nx">@outPorts</span><span class="p">[</span><span class="nx">@errPortName</span><span class="p">]</span> <span class="o">and</span> <span class="nx">@outPorts</span><span class="p">[</span><span class="nx">@errPortName</span><span class="p">].</span><span class="nx">isAttached</span><span class="p">()</span>
          <span class="nx">@outPorts</span><span class="p">[</span><span class="nx">@errPortName</span><span class="p">].</span><span class="nx">send</span> <span class="nx">err</span>
          <span class="nx">@outPorts</span><span class="p">[</span><span class="nx">@errPortName</span><span class="p">].</span><span class="nx">disconnect</span><span class="p">()</span>
        <span class="k">else</span> <span class="k">throw</span> <span class="nx">err</span>
      <span class="nx">@decrementLoad</span><span class="p">()</span>

  <span class="nv">incrementLoad: </span><span class="o">-&gt;</span>
  ...
  <span class="nv">decrementLoad: </span><span class="o">-&gt;</span>
