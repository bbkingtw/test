...
<span class="k">class</span> <span class="nx">Port</span> <span class="k">extends</span> <span class="nx">events</span><span class="p">.</span><span class="nx">EventEmitter</span>
  <span class="nv">constructor: </span><span class="nf">(@type) -&gt;</span>
    ...
    <span class="vi">@downstreamIsGettingReady = </span><span class="kc">false</span>
    ...
    <span class="nx">@</span><span class="kc">on</span> <span class="s">&quot;ready&quot;</span><span class="p">,</span> <span class="p">()</span> <span class="o">=&gt;</span>
      <span class="k">if</span> <span class="nx">@downstreamIsGettingReady</span></pre></div></td></tr><tr id="section-2"><td class="docs"><div class="pilwrap"><a href="#section-2" class="pilcrow">&#182;</a></div><p>Reset the flag</p>
</td><td class="code"><div class="highlight"><pre>        <span class="vi">@downstreamIsGettingReady = </span><span class="kc">false</span></pre></div></td></tr><tr id="section-3"><td class="docs"><div class="pilwrap"><a href="#section-3" class="pilcrow">&#182;</a></div><p>Each record in buffer is a separate connection</p>
</td><td class="code"><div class="highlight"><pre>        <span class="k">for</span> <span class="nx">conn</span> <span class="k">in</span> <span class="nx">@buffer</span>
          <span class="k">for</span> <span class="nx">group</span> <span class="k">in</span> <span class="nx">conn</span><span class="p">.</span><span class="nx">groups</span>
            <span class="nx">@beginGroup</span><span class="p">(</span><span class="nx">group</span><span class="p">)</span>

          <span class="k">for</span> <span class="nx">datum</span> <span class="k">in</span> <span class="nx">conn</span><span class="p">.</span><span class="nx">data</span>
            <span class="nx">@send</span><span class="p">(</span><span class="nx">datum</span><span class="p">)</span>

          <span class="k">for</span> <span class="nx">group</span> <span class="k">in</span> <span class="nx">conn</span><span class="p">.</span><span class="nx">groups</span>
            <span class="nx">@endGroup</span><span class="p">()</span>
  ...
  <span class="nv">attachSocket: </span><span class="nf">(socket, localId = null) -&gt;</span>
    ...
    <span class="nx">socket</span><span class="p">.</span><span class="nx">setMaxListeners</span> <span class="mi">0</span>
  ...
  <span class="nv">connect: </span><span class="o">-&gt;</span>
    <span class="k">if</span> <span class="nx">@downstreamIsGettingReady</span>
  ...
  <span class="nv">send: </span><span class="nf">(data) -&gt;</span>
    <span class="k">if</span> <span class="nx">@downstreamIsGettingReady</span>
      <span class="nx">@data</span><span class="p">.</span><span class="nx">push</span><span class="p">(</span><span class="nx">data</span><span class="p">)</span>
      <span class="k">return</span>
  ...
  <span class="nv">disconnect: </span><span class="o">-&gt;</span>
    <span class="k">if</span> <span class="nx">@downstreamIsGettingReady</span>
      ...
      <span class="nx">@buffer</span><span class="p">.</span><span class="nx">push</span><span class="p">(</span><span class="nx">buffer</span><span class="p">)</span>
