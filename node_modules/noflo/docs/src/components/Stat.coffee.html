...
<span class="k">class</span> <span class="nx">Stat</span> <span class="k">extends</span> <span class="nx">noflo</span><span class="p">.</span><span class="nx">AsyncComponent</span>
  ...
  <span class="nv">doAsync: </span><span class="nf">(path, callback) -&gt;</span>
    <span class="nx">fs</span><span class="p">.</span><span class="nx">stat</span> <span class="nx">path</span><span class="p">,</span> <span class="p">(</span><span class="nx">err</span><span class="p">,</span> <span class="nx">stats</span><span class="p">)</span> <span class="o">=&gt;</span>
      ...
      <span class="nv">stats.path = </span><span class="nx">path</span>
      <span class="k">for</span> <span class="nx">func</span> <span class="k">in</span> <span class="p">[</span><span class="s">&quot;isFile&quot;</span><span class="p">,</span><span class="s">&quot;isDirectory&quot;</span><span class="p">,</span><span class="s">&quot;isBlockDevice&quot;</span><span class="p">,</span>
        <span class="s">&quot;isCharacterDevice&quot;</span><span class="p">,</span> <span class="s">&quot;isFIFO&quot;</span><span class="p">,</span> <span class="s">&quot;isSocket&quot;</span><span class="p">]</span>
        <span class="nx">stats</span><span class="p">[</span><span class="nx">func</span><span class="p">]</span> <span class="o">=</span> <span class="nx">stats</span><span class="p">[</span><span class="nx">func</span><span class="p">]()</span>
      <span class="nx">@outPorts</span><span class="p">.</span><span class="nx">out</span><span class="p">.</span><span class="nx">send</span> <span class="nx">stats</span>
...
<span class="nv">exports.getComponent = </span><span class="o">-&gt;</span> <span class="k">new</span> <span class="nx">Stat</span><span class="p">()</span>
