...
<span class="k">class</span> <span class="nx">GroupRouter</span> <span class="k">extends</span> <span class="nx">noflo</span><span class="p">.</span><span class="nx">Component</span>
  <span class="nv">constructor: </span><span class="o">-&gt;</span>
    ...
    <span class="vi">@inPorts =</span>
      <span class="nv">routes: </span><span class="k">new</span> <span class="nx">noflo</span><span class="p">.</span><span class="nx">Port</span>
    ...
    <span class="vi">@outPorts =</span>
      ...
      <span class="nv">missed: </span><span class="k">new</span> <span class="nx">noflo</span><span class="p">.</span><span class="nx">Port</span>

    <span class="nx">@inPorts</span><span class="p">.</span><span class="nx">routes</span><span class="p">.</span><span class="kc">on</span> <span class="s">&#39;data&#39;</span><span class="p">,</span> <span class="p">(</span><span class="nx">data</span><span class="p">)</span> <span class="o">=&gt;</span>
      <span class="k">if</span> <span class="k">typeof</span> <span class="nx">data</span> <span class="o">is</span> <span class="s">&#39;string&#39;</span>
        <span class="nv">data = </span><span class="nx">data</span><span class="p">.</span><span class="nx">split</span> <span class="s">&#39;,&#39;</span>
      <span class="vi">@routes = </span><span class="nx">data</span>
    ...
    <span class="nx">@inPorts</span><span class="p">.</span><span class="k">in</span><span class="p">.</span><span class="kc">on</span> <span class="s">&#39;data&#39;</span><span class="p">,</span> <span class="p">(</span><span class="nx">data</span><span class="p">)</span> <span class="o">=&gt;</span>
      <span class="nv">selected = </span><span class="nx">@routes</span><span class="p">.</span><span class="nx">indexOf</span> <span class="nx">@groups</span><span class="p">.</span><span class="nx">join</span> <span class="s">&#39;:&#39;</span>
      <span class="k">return</span> <span class="nx">@outPorts</span><span class="p">.</span><span class="nx">missed</span><span class="p">.</span><span class="nx">send</span> <span class="nx">data</span> <span class="k">if</span> <span class="nx">selected</span> <span class="o">is</span> <span class="o">-</span><span class="mi">1</span>
      <span class="nx">@outPorts</span><span class="p">.</span><span class="nx">out</span><span class="p">.</span><span class="nx">send</span> <span class="nx">data</span><span class="p">,</span> <span class="nx">selected</span>
    ...
    <span class="nx">@inPorts</span><span class="p">.</span><span class="k">in</span><span class="p">.</span><span class="kc">on</span> <span class="s">&#39;endgroup&#39;</span><span class="p">,</span> <span class="o">=&gt;</span>
      <span class="nx">do</span> <span class="nx">@groups</span><span class="p">.</span><span class="nx">pop</span>
...
<span class="nv">exports.getComponent = </span><span class="o">-&gt;</span> <span class="k">new</span> <span class="nx">GroupRouter</span>
