...
<span class="s">    the input disconnects&quot;</span>
  ...
  <span class="nv">constructor: </span><span class="o">-&gt;</span>
    ...
    <span class="vi">@outPorts =</span>
      <span class="nv">count: </span><span class="k">new</span> <span class="nx">noflo</span><span class="p">.</span><span class="nx">Port</span>
      <span class="nv">out: </span><span class="k">new</span> <span class="nx">noflo</span><span class="p">.</span><span class="nx">Port</span>
     </pre></div></td></tr><tr id="section-3"><td class="docs"><div class="pilwrap"><a href="#section-3" class="pilcrow">&#182;</a></div><p>When receiving data from IN port</p>
</td><td class="code"><div class="highlight"><pre>    <span class="nx">@inPorts</span><span class="p">.</span><span class="k">in</span><span class="p">.</span><span class="kc">on</span> <span class="s">&#39;data&#39;</span><span class="p">,</span> <span class="p">(</span><span class="nx">data</span><span class="p">)</span> <span class="o">=&gt;</span></pre></div></td></tr><tr id="section-4"><td class="docs"><div class="pilwrap"><a href="#section-4" class="pilcrow">&#182;</a></div><p>Prepare and increment counter</p>
</td><td class="code"><div class="highlight"><pre>      <span class="vi">@count = </span><span class="mi">0</span> <span class="k">if</span> <span class="nx">@count</span> <span class="o">is</span> <span class="kc">null</span>
      <span class="nx">@count</span><span class="o">++</span></pre></div></td></tr><tr id="section-5"><td class="docs"><div class="pilwrap"><a href="#section-5" class="pilcrow">&#182;</a></div><p>Forward the data packet to OUT</p>
</td><td class="code"><div class="highlight"><pre>      <span class="nx">@outPorts</span><span class="p">.</span><span class="nx">out</span><span class="p">.</span><span class="nx">send</span> <span class="nx">data</span> <span class="k">if</span> <span class="nx">@outPorts</span><span class="p">.</span><span class="nx">out</span><span class="p">.</span><span class="nx">isAttached</span><span class="p">()</span>
      </pre></div></td></tr><tr id="section-6"><td class="docs"><div class="pilwrap"><a href="#section-6" class="pilcrow">&#182;</a></div><p>When IN port disconnects we send the COUNT</p>
      ...
      <span class="nx">@outPorts</span><span class="p">.</span><span class="nx">count</span><span class="p">.</span><span class="nx">send</span> <span class="nx">@count</span>
      <span class="nx">@outPorts</span><span class="p">.</span><span class="nx">count</span><span class="p">.</span><span class="nx">disconnect</span><span class="p">()</span>
      <span class="vi">@count = </span><span class="kc">null</span>

<span class="nv">exports.getComponent = </span><span class="o">-&gt;</span> <span class="k">new</span> <span class="nx">Counter</span>
