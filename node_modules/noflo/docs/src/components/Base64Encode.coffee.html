...
data</p>
      ...
      <span class="vi">@data = </span><span class="kc">null</span>
      <span class="vi">@encodedData = </span><span class="s">&quot;&quot;</span>

  <span class="nv">encodeData: </span><span class="o">-&gt;</span></pre></div></td></tr><tr id="section-8"><td class="docs"><div class="pilwrap"><a href="#section-8" class="pilcrow">&#182;</a></div><p>In case of Buffers we already have encoded data
available</p>
</td><td class="code"><div class="highlight"><pre>    <span class="k">return</span> <span class="nx">@encodedData</span> <span class="nx">unless</span> <span class="nx">@encodedData</span> <span class="o">is</span> <span class="s">&quot;&quot;</span></pre></div></td></tr><tr id="section-9"><td class="docs"><div class="pilwrap"><a href="#section-9" class="pilcrow">&#182;</a></div><p>In case of strings we need to encode the data
first</p>
</td><td class="code"><div class="highlight"><pre>    <span class="k">return</span> <span class="k">new</span> <span class="nx">Buffer</span><span class="p">(</span><span class="nx">@data</span><span class="p">).</span><span class="nx">toString</span> <span class="s">&quot;base64&quot;</span>

<span class="nv">exports.getComponent = </span><span class="o">-&gt;</span> <span class="k">new</span> <span class="nx">Base64Encode</span>
