...
<span class="k">class</span> <span class="nx">MapGroup</span> <span class="k">extends</span> <span class="nx">noflo</span><span class="p">.</span><span class="nx">Component</span>
  <span class="nv">constructor: </span><span class="o">-&gt;</span>
    ...
    <span class="nx">@inPorts</span><span class="p">.</span><span class="k">in</span><span class="p">.</span><span class="kc">on</span> <span class="s">&quot;begingroup&quot;</span><span class="p">,</span> <span class="p">(</span><span class="nx">group</span><span class="p">)</span> <span class="o">=&gt;</span>
      <span class="nx">@mapGroup</span> <span class="nx">group</span>
  ...
  <span class="nv">mapGroup: </span><span class="nf">(group) -&gt;</span>
    <span class="k">if</span> <span class="nx">@map</span><span class="p">[</span><span class="nx">group</span><span class="p">]</span>
      <span class="nx">@outPorts</span><span class="p">.</span><span class="nx">out</span><span class="p">.</span><span class="nx">beginGroup</span> <span class="nx">@map</span><span class="p">[</span><span class="nx">group</span><span class="p">]</span>
      <span class="k">return</span>
    ...
    <span class="k">for</span> <span class="nx">expression</span><span class="p">,</span> <span class="nx">replacement</span> <span class="k">of</span> <span class="nx">@regexps</span>
      ...
      <span class="nv">matched = </span><span class="nx">regexp</span><span class="p">.</span><span class="nx">exec</span> <span class="nx">group</span>
      <span class="k">continue</span> <span class="nx">unless</span> <span class="nx">matched</span>
      <span class="nv">group = </span><span class="nx">group</span><span class="p">.</span><span class="nx">replace</span> <span class="nx">regexp</span><span class="p">,</span> <span class="nx">replacement</span>
...
<span class="nv">exports.getComponent = </span><span class="o">-&gt;</span> <span class="k">new</span> <span class="nx">MapGroup</span>
