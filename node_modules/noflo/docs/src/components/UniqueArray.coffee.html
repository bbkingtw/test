...
<span class="k">class</span> <span class="nx">UniqueArray</span> <span class="k">extends</span> <span class="nx">noflo</span><span class="p">.</span><span class="nx">Component</span>
  <span class="nv">constructor: </span><span class="o">-&gt;</span>
    ...
    <span class="nx">@inPorts</span><span class="p">.</span><span class="k">in</span><span class="p">.</span><span class="kc">on</span> <span class="s">&quot;data&quot;</span><span class="p">,</span> <span class="p">(</span><span class="nx">data</span><span class="p">)</span> <span class="o">=&gt;</span>
      <span class="nx">@outPorts</span><span class="p">.</span><span class="nx">out</span><span class="p">.</span><span class="nx">send</span> <span class="nx">@unique</span> <span class="nx">data</span>
  ...
  <span class="nv">unique: </span><span class="nf">(array) -&gt;</span>
    <span class="nv">seen = </span><span class="p">{}</span>
    <span class="nv">newArray = </span><span class="p">[]</span>
    <span class="k">for</span> <span class="nx">member</span> <span class="k">in</span> <span class="nx">array</span>
      <span class="nx">seen</span><span class="p">[</span><span class="nx">member</span><span class="p">]</span> <span class="o">=</span> <span class="nx">member</span>
    <span class="k">for</span> <span class="nx">member</span> <span class="k">of</span> <span class="nx">seen</span>
      <span class="nx">newArray</span><span class="p">.</span><span class="nx">push</span> <span class="nx">member</span>
    <span class="k">return</span> <span class="nx">newArray</span>

<span class="nv">exports.getComponent = </span><span class="o">-&gt;</span> <span class="k">new</span> <span class="nx">UniqueArray</span>
