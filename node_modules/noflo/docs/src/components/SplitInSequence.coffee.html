...
<span class="k">class</span> <span class="nx">SplitInSequence</span> <span class="k">extends</span> <span class="nx">noflo</span><span class="p">.</span><span class="nx">Component</span>
  <span class="nv">constructor: </span><span class="o">-&gt;</span>
    ...
    <span class="nx">@inPorts</span><span class="p">.</span><span class="k">in</span><span class="p">.</span><span class="kc">on</span> <span class="s">&#39;data&#39;</span><span class="p">,</span> <span class="p">(</span><span class="nx">data</span><span class="p">)</span> <span class="o">=&gt;</span>
      <span class="nx">@sendToPort</span> <span class="nx">@portId</span><span class="p">(),</span> <span class="nx">data</span>
  ...
  <span class="nv">portId: </span><span class="o">-&gt;</span>
    <span class="k">if</span> <span class="nx">@lastSent</span> <span class="o">is</span> <span class="kc">null</span>
      <span class="k">return</span> <span class="mi">0</span>
    <span class="nv">next = </span><span class="nx">@lastSent</span> <span class="o">+</span> <span class="mi">1</span>
    <span class="k">if</span> <span class="nx">next</span> <span class="o">&gt;</span> <span class="nx">@outPorts</span><span class="p">.</span><span class="nx">out</span><span class="p">.</span><span class="nx">sockets</span><span class="p">.</span><span class="nx">length</span> <span class="o">-</span> <span class="mi">1</span>
      <span class="k">return</span> <span class="mi">0</span>
    <span class="k">return</span> <span class="nx">next</span>
     
  <span class="nv">sendToPort: </span><span class="nf">(portId, data) -&gt;</span>
    <span class="nx">@outPorts</span><span class="p">.</span><span class="nx">out</span><span class="p">.</span><span class="nx">send</span> <span class="nx">data</span><span class="p">,</span> <span class="nx">portId</span>
    <span class="vi">@lastSent = </span><span class="nx">portId</span>

<span class="nv">exports.getComponent = </span><span class="o">-&gt;</span> <span class="k">new</span> <span class="nx">SplitInSequence</span>
