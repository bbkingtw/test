...
<span class="k">class</span> <span class="nx">RemoveProperty</span> <span class="k">extends</span> <span class="nx">noflo</span><span class="p">.</span><span class="nx">Component</span>
  <span class="nv">constructor: </span><span class="o">-&gt;</span>
    ...
    <span class="nx">@inPorts</span><span class="p">.</span><span class="nx">property</span><span class="p">.</span><span class="kc">on</span> <span class="s">&quot;data&quot;</span><span class="p">,</span> <span class="p">(</span><span class="nx">data</span><span class="p">)</span> <span class="o">=&gt;</span>
      <span class="nx">@properties</span><span class="p">.</span><span class="nx">push</span> <span class="nx">data</span>
    ...
    <span class="nx">@inPorts</span><span class="p">.</span><span class="k">in</span><span class="p">.</span><span class="kc">on</span> <span class="s">&quot;data&quot;</span><span class="p">,</span> <span class="p">(</span><span class="nx">data</span><span class="p">)</span> <span class="o">=&gt;</span>
      <span class="nx">@outPorts</span><span class="p">.</span><span class="nx">out</span><span class="p">.</span><span class="nx">send</span> <span class="nx">@removeProperties</span> <span class="nx">data</span>
  ...
  <span class="nv">removeProperties: </span><span class="nf">(object) -&gt;</span></pre></div></td></tr><tr id="section-2"><td class="docs"><div class="pilwrap"><a href="#section-2" class="pilcrow">&#182;</a></div><p>Clone the object so that the original isn't changed</p>
</td><td class="code"><div class="highlight"><pre>    <span class="nv">object = </span><span class="nx">_</span><span class="p">.</span><span class="nx">clone</span><span class="p">(</span><span class="nx">object</span><span class="p">)</span>

    <span class="k">for</span> <span class="nx">property</span> <span class="k">in</span> <span class="nx">@properties</span>
      <span class="k">delete</span> <span class="nx">object</span><span class="p">[</span><span class="nx">property</span><span class="p">]</span>
    <span class="k">return</span> <span class="nx">object</span>

<span class="nv">exports.getComponent = </span><span class="o">-&gt;</span> <span class="k">new</span> <span class="nx">RemoveProperty</span>
