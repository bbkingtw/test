...
<span class="k">class</span> <span class="nx">Output</span> <span class="k">extends</span> <span class="nx">noflo</span><span class="p">.</span><span class="nx">Component</span>

  <span class="nv">description: </span><span class="s">&quot;This component receives input on a single inport, and</span>
<span class="s">    sends the data items directly to console.log&quot;</span>

  <span class="nv">constructor: </span><span class="o">-&gt;</span>
    <span class="vi">@options =</span>
      <span class="nv">showHidden: </span><span class="kc">false</span>
      <span class="nv">depth: </span><span class="mi">2</span>
      <span class="nv">colors: </span><span class="kc">false</span>
    ...
    <span class="vi">@inPorts =</span>
      ...
      <span class="nv">options: </span><span class="k">new</span> <span class="nx">noflo</span><span class="p">.</span><span class="nx">Port</span>
    ...
    <span class="nx">@inPorts</span><span class="p">.</span><span class="k">in</span><span class="p">.</span><span class="kc">on</span> <span class="s">&quot;data&quot;</span><span class="p">,</span> <span class="p">(</span><span class="nx">data</span><span class="p">)</span> <span class="o">=&gt;</span>
      <span class="nx">@log</span> <span class="nx">data</span>
      <span class="nx">@outPorts</span><span class="p">.</span><span class="nx">out</span><span class="p">.</span><span class="nx">send</span> <span class="nx">data</span> <span class="k">if</span> <span class="nx">@outPorts</span><span class="p">.</span><span class="nx">out</span><span class="p">.</span><span class="nx">isAttached</span><span class="p">()</span>
    ...
    <span class="nx">@inPorts</span><span class="p">.</span><span class="nx">options</span><span class="p">.</span><span class="kc">on</span> <span class="s">&quot;data&quot;</span><span class="p">,</span> <span class="p">(</span><span class="nx">data</span><span class="p">)</span> <span class="o">=&gt;</span>
      <span class="nx">@setOptions</span> <span class="nx">data</span>

  <span class="nv">setOptions: </span><span class="nf">(options) -&gt;</span>
    <span class="k">throw</span> <span class="k">new</span> <span class="nb">Error</span> <span class="s">&quot;Options is not an object&quot;</span> <span class="nx">unless</span> <span class="k">typeof</span> <span class="nx">options</span> <span class="o">is</span> <span class="s">&quot;object&quot;</span>
    <span class="k">for</span> <span class="nx">own</span> <span class="nx">key</span><span class="p">,</span> <span class="nx">value</span> <span class="k">of</span> <span class="nx">options</span>
  ...
  <span class="nv">log: </span><span class="nf">(data) -&gt;</span>
    <span class="nx">console</span><span class="p">.</span><span class="nx">log</span> <span class="nx">util</span><span class="p">.</span><span class="nx">inspect</span> <span class="nx">data</span><span class="p">,</span>
      <span class="nx">@options</span><span class="p">.</span><span class="nx">showHidden</span><span class="p">,</span> <span class="nx">@options</span><span class="p">.</span><span class="nx">depth</span><span class="p">,</span> <span class="nx">@options</span><span class="p">.</span><span class="nx">colors</span>

<span class="nv">exports.getComponent = </span><span class="o">-&gt;</span>
  <span class="k">new</span> <span class="nx">Output</span><span class="p">()</span>
