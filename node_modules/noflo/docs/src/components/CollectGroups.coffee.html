...
<span class="k">class</span> <span class="nx">CollectGroups</span> <span class="k">extends</span> <span class="nx">noflo</span><span class="p">.</span><span class="nx">Component</span>
  <span class="nv">constructor: </span><span class="o">-&gt;</span>
    <span class="vi">@data = </span><span class="p">{}</span>
    <span class="vi">@groups = </span><span class="p">[]</span>
    <span class="vi">@parents = </span><span class="p">[]</span>
    ...
    <span class="nx">@inPorts</span><span class="p">.</span><span class="k">in</span><span class="p">.</span><span class="kc">on</span> <span class="s">&quot;begingroup&quot;</span><span class="p">,</span> <span class="p">(</span><span class="nx">group</span><span class="p">)</span> <span class="o">=&gt;</span>
      <span class="k">throw</span> <span class="k">new</span> <span class="nb">Error</span> <span class="s">&quot;groups cannot be named &#39;$data&#39;&quot;</span> <span class="k">if</span> <span class="nx">group</span> <span class="o">==</span> <span class="s">&quot;$data&quot;</span>
      <span class="nx">@parents</span><span class="p">.</span><span class="nx">push</span> <span class="nx">@data</span>
    ...
    <span class="nx">@inPorts</span><span class="p">.</span><span class="k">in</span><span class="p">.</span><span class="kc">on</span> <span class="s">&quot;data&quot;</span><span class="p">,</span> <span class="p">(</span><span class="nx">data</span><span class="p">)</span> <span class="o">=&gt;</span>
      <span class="nx">@setData</span> <span class="nx">data</span>
    <span class="nx">@inPorts</span><span class="p">.</span><span class="k">in</span><span class="p">.</span><span class="kc">on</span> <span class="s">&quot;endgroup&quot;</span><span class="p">,</span> <span class="o">=&gt;</span>
      ...
      <span class="vi">@data = </span><span class="nx">@parents</span><span class="p">.</span><span class="nx">pop</span><span class="p">()</span>
      <span class="nx">@addChild</span> <span class="nx">@data</span><span class="p">,</span> <span class="nx">@groups</span><span class="p">.</span><span class="nx">pop</span><span class="p">(),</span> <span class="nx">data</span>
  ...
  <span class="nv">addChild: </span><span class="nf">(parent, child, data) -&gt;</span>
    <span class="k">return</span> <span class="nx">parent</span><span class="p">[</span><span class="nx">child</span><span class="p">]</span> <span class="o">=</span> <span class="nx">data</span> <span class="nx">unless</span> <span class="nx">child</span> <span class="k">of</span> <span class="nx">parent</span>
    <span class="k">return</span> <span class="nx">parent</span><span class="p">[</span><span class="nx">child</span><span class="p">].</span><span class="nx">push</span> <span class="nx">data</span> <span class="k">if</span> <span class="nb">Array</span><span class="p">.</span><span class="nx">isArray</span> <span class="nx">parent</span><span class="p">[</span><span class="nx">child</span><span class="p">]</span>
    <span class="nx">parent</span><span class="p">[</span><span class="nx">child</span><span class="p">]</span> <span class="o">=</span> <span class="p">[</span> <span class="nx">parent</span><span class="p">[</span><span class="nx">child</span><span class="p">],</span> <span class="nx">data</span> <span class="p">]</span>

  <span class="nv">setData: </span><span class="nf">(data) -&gt;</span>
    <span class="nx">@data</span><span class="p">.</span><span class="nv">$data = </span><span class="p">[]</span> <span class="nx">unless</span> <span class="s">&quot;$data&quot;</span> <span class="k">of</span> <span class="nx">@data</span>
    <span class="nx">@data</span><span class="p">.</span><span class="nx">$data</span><span class="p">.</span><span class="nx">push</span> <span class="nx">data</span>

  <span class="nv">setDataToKey: </span><span class="nf">(target, key, value) -&gt;</span>
    <span class="nx">target</span><span class="p">[</span><span class="nx">key</span><span class="p">].</span><span class="nv">value = </span><span class="nx">value</span>

<span class="nv">exports.getComponent = </span><span class="o">-&gt;</span> <span class="k">new</span> <span class="nx">CollectGroups</span>
