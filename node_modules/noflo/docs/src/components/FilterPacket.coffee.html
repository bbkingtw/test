...
<span class="k">class</span> <span class="nx">FilterPacket</span> <span class="k">extends</span> <span class="nx">noflo</span><span class="p">.</span><span class="nx">Component</span>
  <span class="nv">constructor: </span><span class="o">-&gt;</span>
    ...
    <span class="nx">@inPorts</span><span class="p">.</span><span class="nx">regexp</span><span class="p">.</span><span class="kc">on</span> <span class="s">&quot;data&quot;</span><span class="p">,</span> <span class="p">(</span><span class="nx">data</span><span class="p">)</span> <span class="o">=&gt;</span>
      <span class="nx">@regexps</span><span class="p">.</span><span class="nx">push</span> <span class="nx">data</span>
    ...
    <span class="nx">@inPorts</span><span class="p">.</span><span class="k">in</span><span class="p">.</span><span class="kc">on</span> <span class="s">&quot;data&quot;</span><span class="p">,</span> <span class="p">(</span><span class="nx">data</span><span class="p">)</span> <span class="o">=&gt;</span>
      <span class="k">return</span> <span class="nx">@filterData</span> <span class="nx">data</span> <span class="k">if</span> <span class="nx">@regexps</span><span class="p">.</span><span class="nx">length</span>
  ...
  <span class="nv">filterData: </span><span class="nf">(data) -&gt;</span>
    <span class="nv">match = </span><span class="kc">false</span>
    <span class="k">for</span> <span class="nx">expression</span> <span class="k">in</span> <span class="nx">@regexps</span>
      <span class="nv">regexp = </span><span class="k">new</span> <span class="nb">RegExp</span> <span class="nx">expression</span>
      <span class="k">continue</span> <span class="nx">unless</span> <span class="nx">regexp</span><span class="p">.</span><span class="nx">exec</span> <span class="nx">data</span>
      <span class="nv">match = </span><span class="kc">true</span>

    <span class="nx">unless</span> <span class="nx">match</span>
      <span class="nx">@outPorts</span><span class="p">.</span><span class="nx">missed</span><span class="p">.</span><span class="nx">send</span> <span class="nx">data</span> <span class="k">if</span> <span class="nx">@outPorts</span><span class="p">.</span><span class="nx">missed</span><span class="p">.</span><span class="nx">isAttached</span><span class="p">()</span>
      <span class="k">return</span>

    <span class="nx">@outPorts</span><span class="p">.</span><span class="nx">out</span><span class="p">.</span><span class="nx">send</span> <span class="nx">data</span>

<span class="nv">exports.getComponent = </span><span class="o">-&gt;</span> <span class="k">new</span> <span class="nx">FilterPacket</span>
