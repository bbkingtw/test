...
<span class="k">class</span> <span class="nx">SliceArray</span> <span class="k">extends</span> <span class="nx">noflo</span><span class="p">.</span><span class="nx">Component</span>
  <span class="nv">constructor: </span><span class="o">-&gt;</span>
    ...
    <span class="vi">@inPorts =</span>
      ...
      <span class="nv">begin: </span><span class="k">new</span> <span class="nx">noflo</span><span class="p">.</span><span class="nx">Port</span><span class="p">()</span>
      <span class="nv">end: </span><span class="k">new</span> <span class="nx">noflo</span><span class="p">.</span><span class="nx">Port</span><span class="p">()</span>
    ...
    <span class="nx">@inPorts</span><span class="p">.</span><span class="nx">begin</span><span class="p">.</span><span class="kc">on</span> <span class="s">&quot;data&quot;</span><span class="p">,</span> <span class="p">(</span><span class="nx">data</span><span class="p">)</span> <span class="o">=&gt;</span>
      <span class="vi">@begin = </span><span class="nx">data</span>
    <span class="nx">@inPorts</span><span class="p">.</span><span class="nx">end</span><span class="p">.</span><span class="kc">on</span> <span class="s">&quot;data&quot;</span><span class="p">,</span> <span class="p">(</span><span class="nx">data</span><span class="p">)</span> <span class="o">=&gt;</span>
      <span class="vi">@end = </span><span class="nx">data</span>
    ...
    <span class="nx">@inPorts</span><span class="p">.</span><span class="k">in</span><span class="p">.</span><span class="kc">on</span> <span class="s">&quot;data&quot;</span><span class="p">,</span> <span class="p">(</span><span class="nx">data</span><span class="p">)</span> <span class="o">=&gt;</span>
      <span class="nx">@sliceData</span> <span class="nx">data</span>
  ...
  <span class="nv">sliceData: </span><span class="nf">(data) -&gt;</span>
    <span class="k">return</span> <span class="nx">@outPorts</span><span class="p">.</span><span class="nx">error</span><span class="p">.</span><span class="nx">send</span> <span class="s">&quot;Data </span><span class="si">#{</span><span class="k">typeof</span> <span class="nx">data</span><span class="si">}</span><span class="s"> cannot be sliced&quot;</span> <span class="nx">unless</span> <span class="nx">data</span><span class="p">.</span><span class="nx">slice</span>
    <span class="nv">sliced = </span><span class="nx">data</span><span class="p">.</span><span class="nx">slice</span> <span class="nx">@begin</span><span class="p">,</span> <span class="nx">@end</span> <span class="nx">unless</span> <span class="nx">@end</span> <span class="o">is</span> <span class="kc">null</span>
    <span class="nv">sliced = </span><span class="nx">data</span><span class="p">.</span><span class="nx">slice</span> <span class="nx">@begin</span> <span class="k">if</span> <span class="nx">@end</span> <span class="o">is</span> <span class="kc">null</span>
    <span class="nx">@outPorts</span><span class="p">.</span><span class="nx">out</span><span class="p">.</span><span class="nx">send</span> <span class="nx">sliced</span>

<span class="nv">exports.getComponent = </span><span class="o">-&gt;</span> <span class="k">new</span> <span class="nx">SliceArray</span>

</pre></div></td></tr></tbody></table><div id="generated">generated Wed Apr 03 2013 16:29:45 GMT+0200 (CEST)  </div><div id="projectname"><a href="../../index.html">NoFlo</a></div></div></body></html>