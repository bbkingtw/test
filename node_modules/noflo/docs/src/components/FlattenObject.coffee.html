...
<span class="k">class</span> <span class="nx">FlattenObject</span> <span class="k">extends</span> <span class="nx">noflo</span><span class="p">.</span><span class="nx">Component</span>
  <span class="nv">constructor: </span><span class="o">-&gt;</span>
    ...
    <span class="nx">@inPorts</span><span class="p">.</span><span class="k">in</span><span class="p">.</span><span class="kc">on</span> <span class="s">&quot;data&quot;</span><span class="p">,</span> <span class="p">(</span><span class="nx">data</span><span class="p">)</span> <span class="o">=&gt;</span>
      <span class="k">for</span> <span class="nx">object</span> <span class="k">in</span> <span class="nx">@flattenObject</span> <span class="nx">data</span>
        <span class="nx">@outPorts</span><span class="p">.</span><span class="nx">out</span><span class="p">.</span><span class="nx">send</span> <span class="nx">@mapKeys</span> <span class="nx">object</span>
  ...
  <span class="nv">mapKeys: </span><span class="nf">(object) -&gt;</span>
    <span class="k">for</span> <span class="nx">key</span><span class="p">,</span> <span class="nx">map</span> <span class="k">of</span> <span class="nx">@map</span>
      <span class="nx">object</span><span class="p">[</span><span class="nx">map</span><span class="p">]</span> <span class="o">=</span> <span class="nx">object</span><span class="p">.</span><span class="nx">flattenedKeys</span><span class="p">[</span><span class="nx">key</span><span class="p">]</span>
    <span class="k">delete</span> <span class="nx">object</span><span class="p">.</span><span class="nx">flattenedKeys</span>
    <span class="k">return</span> <span class="nx">object</span>

  <span class="nv">flattenObject: </span><span class="nf">(object) -&gt;</span>
    ...
    <span class="k">for</span> <span class="nx">key</span><span class="p">,</span> <span class="nx">value</span> <span class="k">of</span> <span class="nx">object</span>
      <span class="k">if</span> <span class="k">typeof</span> <span class="nx">value</span> <span class="o">is</span> <span class="s">&quot;object&quot;</span>
        <span class="nv">flattenedValue = </span><span class="nx">@flattenObject</span> <span class="nx">value</span>
        <span class="k">for</span> <span class="nx">val</span> <span class="k">in</span> <span class="nx">flattenedValue</span>
          <span class="nx">val</span><span class="p">.</span><span class="nx">flattenedKeys</span><span class="p">.</span><span class="nx">push</span> <span class="nx">key</span>
          <span class="nx">flattened</span><span class="p">.</span><span class="nx">push</span> <span class="nx">val</span>
        <span class="k">continue</span>

      <span class="nx">flattened</span><span class="p">.</span><span class="nx">push</span>
        <span class="nv">flattenedKeys: </span><span class="p">[</span><span class="nx">key</span><span class="p">]</span>
        <span class="nv">value: </span><span class="nx">value</span>

    <span class="k">return</span> <span class="nx">flattened</span>

<span class="nv">exports.getComponent = </span><span class="o">-&gt;</span> <span class="k">new</span> <span class="nx">FlattenObject</span>

</pre></div></td></tr></tbody></table><div id="generated">generated Wed Apr 03 2013 16:29:49 GMT+0200 (CEST)  </div><div id="projectname"><a href="../../index.html">NoFlo</a></div></div></body></html>