...
<span class="k">class</span> <span class="nx">SetProperty</span> <span class="k">extends</span> <span class="nx">noflo</span><span class="p">.</span><span class="nx">Component</span>
  ...
  <span class="nv">setProperty: </span><span class="nf">(prop) -&gt;</span>
    ...
    <span class="nx">@properties</span><span class="p">[</span><span class="nx">propParts</span><span class="p">[</span><span class="mi">0</span><span class="p">]]</span> <span class="o">=</span> <span class="nx">propParts</span><span class="p">[</span><span class="mi">1</span><span class="p">]</span>

  <span class="nv">addProperties: </span><span class="nf">(object) -&gt;</span>
    <span class="k">for</span> <span class="nx">property</span><span class="p">,</span> <span class="nx">value</span> <span class="k">of</span> <span class="nx">@properties</span>
      <span class="nx">object</span><span class="p">[</span><span class="nx">property</span><span class="p">]</span> <span class="o">=</span> <span class="nx">value</span>
...
<span class="nv">exports.getComponent = </span><span class="o">-&gt;</span> <span class="k">new</span> <span class="nx">SetProperty</span>
