...
<span class="k">class</span> <span class="nx">Throttle</span> <span class="k">extends</span> <span class="nx">noflo</span><span class="p">.</span><span class="nx">Component</span>
  ...
  <span class="nv">constructor: </span><span class="o">-&gt;</span>
    <span class="vi">@inPorts =</span>
      ...
      <span class="nv">load: </span><span class="k">new</span> <span class="nx">noflo</span><span class="p">.</span><span class="nx">Port</span><span class="p">()</span>
      <span class="nv">max: </span><span class="k">new</span> <span class="nx">noflo</span><span class="p">.</span><span class="nx">Port</span><span class="p">()</span>
    ...
    <span class="vi">@max = </span><span class="mi">10</span>

    <span class="nx">@inPorts</span><span class="p">.</span><span class="nx">load</span><span class="p">.</span><span class="kc">on</span> <span class="s">&quot;data&quot;</span><span class="p">,</span> <span class="p">(</span><span class="nx">data</span><span class="p">)</span> <span class="o">=&gt;</span>
      <span class="vi">@load = </span><span class="nx">data</span>
      <span class="nx">@process</span><span class="p">()</span>

    <span class="nx">@inPorts</span><span class="p">.</span><span class="nx">max</span><span class="p">.</span><span class="kc">on</span> <span class="s">&quot;data&quot;</span><span class="p">,</span> <span class="p">(</span><span class="nx">data</span><span class="p">)</span> <span class="o">=&gt;</span>
      <span class="vi">@max = </span><span class="nb">parseInt</span> <span class="nx">data</span>
      <span class="nx">@process</span><span class="p">()</span>
    ...
    <span class="nx">@inPorts</span><span class="p">.</span><span class="k">in</span><span class="p">.</span><span class="kc">on</span> <span class="s">&quot;data&quot;</span><span class="p">,</span> <span class="p">(</span><span class="nx">data</span><span class="p">)</span> <span class="o">=&gt;</span>
      <span class="nx">@push</span> <span class="s">&quot;data&quot;</span><span class="p">,</span> <span class="nx">data</span>
    ...
    <span class="nx">@inPorts</span><span class="p">.</span><span class="k">in</span><span class="p">.</span><span class="kc">on</span> <span class="s">&quot;disconnect&quot;</span><span class="p">,</span> <span class="o">=&gt;</span>
      <span class="nx">@push</span> <span class="s">&quot;disconnect&quot;</span>

  <span class="nv">push: </span><span class="nf">(eventname, data) -&gt;</span>
    <span class="nx">@q</span><span class="p">.</span><span class="nx">push</span>
      <span class="nv">name: </span><span class="nx">eventname</span>
      <span class="nv">data: </span><span class="nx">data</span>
      <span class="nv">groups: </span><span class="nx">@groups</span><span class="p">.</span><span class="nx">slice</span> <span class="mi">0</span>
    <span class="nx">@process</span><span class="p">()</span>

  <span class="nv">process: </span><span class="o">-&gt;</span>
    <span class="nv">sent = </span><span class="mi">0</span>
    <span class="k">while</span> <span class="nx">@q</span><span class="p">.</span><span class="nx">length</span> <span class="o">&gt;</span> <span class="mi">0</span> <span class="o">and</span> <span class="nx">@load</span> <span class="o">&lt;</span> <span class="nx">@max</span>
      <span class="k">return</span> <span class="k">if</span> <span class="nx">sent</span> <span class="o">&gt;=</span> <span class="nx">@max</span>
      <span class="nv">event = </span><span class="nx">@q</span><span class="p">.</span><span class="nx">shift</span><span class="p">()</span>
      <span class="k">switch</span> <span class="nx">event</span><span class="p">.</span><span class="nx">name</span>
        <span class="k">when</span> <span class="s">&quot;data&quot;</span>
          <span class="k">for</span> <span class="nx">group</span> <span class="k">in</span> <span class="nx">event</span><span class="p">.</span><span class="nx">groups</span>
          ...
          <span class="nx">@outPorts</span><span class="p">.</span><span class="nx">out</span><span class="p">.</span><span class="nx">send</span> <span class="nx">event</span><span class="p">.</span><span class="nx">data</span>
          <span class="k">for</span> <span class="nx">group</span> <span class="k">in</span> <span class="nx">event</span><span class="p">.</span><span class="nx">groups</span>
        ...
        <span class="k">when</span> <span class="s">&quot;disconnect&quot;</span> <span class="k">then</span> <span class="nx">@outPorts</span><span class="p">.</span><span class="nx">out</span><span class="p">.</span><span class="nx">disconnect</span><span class="p">()</span>
      <span class="nx">sent</span><span class="o">++</span>

<span class="nv">exports.getComponent = </span><span class="o">-&gt;</span> <span class="k">new</span> <span class="nx">Throttle</span><span class="p">()</span>
