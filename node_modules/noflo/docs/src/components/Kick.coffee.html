...
<span class="s">  be useful for starting up networks.&quot;</span>
  ...
  <span class="nv">constructor: </span><span class="o">-&gt;</span>
    ...
    <span class="vi">@inPorts =</span>
      ...
      <span class="nv">data: </span><span class="k">new</span> <span class="nx">noflo</span><span class="p">.</span><span class="nx">Port</span><span class="p">()</span>

    <span class="vi">@outPorts =</span>
      <span class="nv">out: </span><span class="k">new</span> <span class="nx">noflo</span><span class="p">.</span><span class="nx">ArrayPort</span><span class="p">()</span>
    ...
    <span class="nx">@inPorts</span><span class="p">.</span><span class="k">in</span><span class="p">.</span><span class="kc">on</span> <span class="s">&#39;data&#39;</span><span class="p">,</span> <span class="o">=&gt;</span>
      <span class="vi">@data.group = </span><span class="nx">@groups</span><span class="p">.</span><span class="nx">slice</span> <span class="mi">0</span>
    ...
    <span class="nx">@inPorts</span><span class="p">.</span><span class="k">in</span><span class="p">.</span><span class="kc">on</span> <span class="s">&#39;disconnect&#39;</span><span class="p">,</span> <span class="o">=&gt;</span>
      <span class="nx">@sendKick</span> <span class="nx">@data</span>
      <span class="vi">@groups = </span><span class="p">[]</span>

    <span class="nx">@inPorts</span><span class="p">.</span><span class="nx">data</span><span class="p">.</span><span class="kc">on</span> <span class="s">&#39;data&#39;</span><span class="p">,</span> <span class="p">(</span><span class="nx">data</span><span class="p">)</span> <span class="o">=&gt;</span>
      <span class="vi">@data.packet = </span><span class="nx">data</span>

  <span class="nv">sendKick: </span><span class="nf">(kick) -&gt;</span>
    <span class="k">for</span> <span class="nx">group</span> <span class="k">in</span> <span class="nx">kick</span><span class="p">.</span><span class="nx">group</span>
    ...
    <span class="nx">@outPorts</span><span class="p">.</span><span class="nx">out</span><span class="p">.</span><span class="nx">send</span> <span class="nx">kick</span><span class="p">.</span><span class="nx">packet</span>
...
<span class="nv">exports.getComponent = </span><span class="o">-&gt;</span> <span class="k">new</span> <span class="nx">Kick</span>
