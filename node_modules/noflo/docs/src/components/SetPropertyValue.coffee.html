...
<span class="k">class</span> <span class="nx">SetPropertyValue</span> <span class="k">extends</span> <span class="nx">noflo</span><span class="p">.</span><span class="nx">Component</span>
  <span class="nv">constructor: </span><span class="o">-&gt;</span>
    ...
    <span class="vi">@inPorts =</span>
      <span class="nv">property: </span><span class="k">new</span> <span class="nx">noflo</span><span class="p">.</span><span class="nx">Port</span><span class="p">()</span>
      <span class="nv">value: </span><span class="k">new</span> <span class="nx">noflo</span><span class="p">.</span><span class="nx">Port</span><span class="p">()</span>
    ...
    <span class="nx">@inPorts</span><span class="p">.</span><span class="nx">property</span><span class="p">.</span><span class="kc">on</span> <span class="s">&quot;data&quot;</span><span class="p">,</span> <span class="p">(</span><span class="nx">data</span><span class="p">)</span> <span class="o">=&gt;</span>
      <span class="vi">@property = </span><span class="nx">data</span>
      <span class="nx">@addProperties</span><span class="p">()</span> <span class="k">if</span> <span class="nx">@value</span> <span class="o">and</span> <span class="nx">@data</span><span class="p">.</span><span class="nx">length</span>
    <span class="nx">@inPorts</span><span class="p">.</span><span class="nx">value</span><span class="p">.</span><span class="kc">on</span> <span class="s">&quot;data&quot;</span><span class="p">,</span> <span class="p">(</span><span class="nx">data</span><span class="p">)</span> <span class="o">=&gt;</span>
      <span class="vi">@value = </span><span class="nx">data</span>
      <span class="nx">@addProperties</span><span class="p">()</span> <span class="k">if</span> <span class="nx">@property</span> <span class="o">and</span> <span class="nx">@data</span><span class="p">.</span><span class="nx">length</span>
    ...
    <span class="nx">@inPorts</span><span class="p">.</span><span class="k">in</span><span class="p">.</span><span class="kc">on</span> <span class="s">&quot;data&quot;</span><span class="p">,</span> <span class="p">(</span><span class="nx">data</span><span class="p">)</span> <span class="o">=&gt;</span>
      <span class="k">if</span> <span class="nx">@property</span> <span class="o">and</span> <span class="nx">@value</span>
        <span class="nx">@addProperty</span>
          <span class="nv">data: </span><span class="nx">data</span>
          <span class="nv">group: </span><span class="nx">@groups</span><span class="p">.</span><span class="nx">slice</span> <span class="mi">0</span>
    ...
    <span class="nx">@inPorts</span><span class="p">.</span><span class="k">in</span><span class="p">.</span><span class="kc">on</span> <span class="s">&quot;disconnect&quot;</span><span class="p">,</span> <span class="o">=&gt;</span>
      <span class="nx">@outPorts</span><span class="p">.</span><span class="nx">out</span><span class="p">.</span><span class="nx">disconnect</span><span class="p">()</span> <span class="k">if</span> <span class="nx">@property</span> <span class="o">and</span> <span class="nx">@value</span>
      <span class="vi">@value = </span><span class="kc">null</span>

  <span class="nv">addProperty: </span><span class="nf">(object) -&gt;</span>
    <span class="nx">object</span><span class="p">.</span><span class="nx">data</span><span class="p">[</span><span class="nx">@property</span><span class="p">]</span> <span class="o">=</span> <span class="nx">@value</span>
    <span class="k">for</span> <span class="nx">group</span> <span class="k">in</span> <span class="nx">object</span><span class="p">.</span><span class="nx">group</span>
    ...
    <span class="nx">@outPorts</span><span class="p">.</span><span class="nx">out</span><span class="p">.</span><span class="nx">send</span> <span class="nx">object</span><span class="p">.</span><span class="nx">data</span>
    <span class="k">for</span> <span class="nx">group</span> <span class="k">in</span> <span class="nx">object</span><span class="p">.</span><span class="nx">group</span>
  ...
  <span class="nv">addProperties: </span><span class="o">-&gt;</span>
    <span class="nx">@addProperty</span> <span class="nx">object</span> <span class="k">for</span> <span class="nx">object</span> <span class="k">in</span> <span class="nx">@data</span>
    <span class="vi">@data = </span><span class="p">[]</span>
...
<span class="nv">exports.getComponent = </span><span class="o">-&gt;</span> <span class="k">new</span> <span class="nx">SetPropertyValue</span>
